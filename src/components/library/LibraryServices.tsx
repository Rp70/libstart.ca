    ...
    <div className="space-y-8">
      ...
      <Card className="bg-gradient-to-br from-primary/10 to-accent/10 p-8">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h3 className="text-2xl font-semibold mb-2">{t('services.mostLibraries')}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {serviceGroups.most.map((service) => {
            ...
            return (
              <Card key={service.id} className="p-5 bg-background/80 backdrop-blur-sm hover:shadow-md transition-shadow">
      ...
      <Card className="bg-gradient-to-br from-accent/10 to-secondary/10 p-8">
        <div className="flex items-start gap-4 mb-6">
          <div className="bg-accent text-accent-foreground p-3 rounded-lg">
            <Cube size={28} weight="duotone" />
          </div>
          <div>
            <h3 className="text-2xl font-semibold mb-2">{t('services.someLibraries')}</h3>
            <p className="text-muted-foreground">
      ...
      <Card className="bg-gradient-to-br from-sage/20 to-primary/10 p-6">
        <h3 className="text-xl font-semibold mb-4">{t('services.tipTitle')}</h3>
